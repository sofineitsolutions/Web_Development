            ...
            <div class="single_slider  d-flex align-items-center slider_bg_1 overlay">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                            <?php echo"<span>".$title7."</span>";?>
                            <?php echo "<h3>".$title8."</h3>";?>
                            <?php echo "<p>".$title9."</p>";?>
                                <a href="#" class="boxed-btn3">Join Us</a>
                            </div>
                        </div>
            ...
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                            <?php echo"<span>".$title10."</span>";?>
                            <?php echo "<h3>".$title11."</h3>";?>
                            <?php echo "<p>".$title12."</p>";?>
                                <a href="#" class="boxed-btn3">Join Us</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single_prising text-center">
                            <div class="prising_header">
                                <?php echo "<h3>".$ptitle2."</h3>";
                                echo "<span>".$price2."</span>";?>
                            </div>
                            <div class="pricing_body">
                                <ul>
