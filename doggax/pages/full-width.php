...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <?php echo("<p>" . $dec1 . "</p>");
      echo("<p>" . $dec2 . "<a href='#'>" . $dec3 . "</a>" . $dec4 . "</p>"); ?>
      <img class="imgl borderedbox inspace-5" src="../images/demo/imgl.gif" alt="">
      <?php echo("<p>" . $dec5 . "<a href='https://www.os-templates.com/' title='Free Website Templates'>" . $dec6 . "</a>" . $dec7 . "<ahref='https://www.os-templates.com/template-terms'>" . $dec8 . "</a>.</p><p>" . $dec9 . "<a href='https://www.os-templates.com/'>" . $dec10 . "</a>" . $dec11 . "</p><p>" . $dec12 . "</p>"); ?>
      <h1>Table(s)</h1>
