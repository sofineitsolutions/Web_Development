...
<section class="about section">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				<h2 class="mt-40"><?php echo($dddd1);  ?></h2>
				<p><?php echo($p1); ?></p>
				<a href="#" class="btn btn-small mt-20"><?php echo($button4); ?></a>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="service-item">
		          ...
		          <h4><?php echo($list7);  ?></h4>
		          <p><?php echo($theme_des); ?> </p>
		        </div>
			</div>
			<div class="col-md-4">
				<div class="service-item">
		          <i class="ion-ios-unlocked-outline"></i>
		          <h4><?php echo($list8);  ?></h4>
		          <p><?php echo($theme_des); ?></p>
		        </div>
			</div>
			<div class="col-md-4">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="block">
					<h2><?php echo($end); ?></h2>
					<p><?php echo($end_des); ?></p>
					<a class="btn btn-main btn-solid-border" href="#" ><?php echo($button5); ?></a>
				</div>
			</div>
		</div>
	</div>
