		...
		<div class="row">
			<div class="col-md-12">
				<div class="block">
					...
					<p class="animated fadeInUp"><?php echo($des);  ?></p>
					<a href="https://themefisher.com/free-bootstrap-templates/" target="_blank" class="btn btn-main animated fadeInUp" ><?php echo($button); ?></a>
				</div>
			</div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-md-offset-6">
        <h2 class="section-subtitle"><?php echo($section); ?></h2>
        <?php echo($para); ?>
        <?php echo($para1); ?>
        <?php echo($para2); ?>
        <a href="#" class="btn btn-view-works"><?php echo($button1); ?></a>
      </div>
    </div>
  </div>
</section>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="block">
					...
					<?php echo($describe); ?>
					<a class="btn btn-main btn-solid-border" href="#" ><?php echo($button2); ?></a>
				</div>
			</div>
		</div>
	</div>
