...
<head>
  ...
  <title>Airspace | Creative Agency Bootstrap template(faq.php)</title>
            ...
            <form id="contact-form"  action="insert4.php" method="POST">
                <div class="col-md-6 col-sm-12">
                    <div class="block">
                        ...
                        <div class="form-group">
                            <input name="head1" type="text" class="form-control" placeholder="Head1">
                        </div>
                        <div class="form-group">
                            <input name="des1" type="text" class="form-control" placeholder="description1">
                        </div>
                        <div class="form-group">
                            <input name="head2" type="text" class="form-control" placeholder="Head2">
                        </div>
                        <div class="form-group">
                            <input name="des2" type="text" class="form-control" placeholder="description2">
                        </div>
                        <div class="form-group">
                            <input name="head3" type="text" class="form-control" placeholder="Head3">
                        </div>
                        <div class="form-group">
                            <input name="des3" type="text" class="form-control" placeholder="description3">
                        </div>
                        <div class="form-group">
                            <input name="head4" type="text" class="form-control" placeholder="Head4">
                        </div>
                        <div class="form-group">
                            <input name="des4" type="text" class="form-control" placeholder="description4">
                        </div>
                        <div class="form-group">
                            <input name="head5" type="text" class="form-control" placeholder="Head5">
                        </div>
                        <div class="form-group">
                            <input name="des5" type="text" class="form-control" placeholder="description5">
                        </div>
                        <div class="form-group">
                            <input name="head6" type="text" class="form-control" placeholder="Head6">
                        </div>
                        <div class="form-group">
                            <input name="des6" type="text" class="form-control" placeholder="description6">
                        </div>
                        <div class="form-group">
                            <input name="head7" type="text" class="form-control" placeholder="Head7">
                        </div>
                        <div class="form-group">
                            <input name="des7" type="text" class="form-control" placeholder="description7">
                        </div>
                        <div class="form-group">
                            <input name="head8" type="text" class="form-control" placeholder="Head8">
                        </div>
                        <div class="form-group">
                            <input name="head9" type="text" class="form-control" placeholder="Head9">
                        </div>
                        <div class="form-group">
                            <input name="head10" type="text" class="form-control" placeholder="Head10">
                        </div>
                        <div class="form-group">
