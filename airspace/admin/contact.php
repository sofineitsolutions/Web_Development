                ...
                <div class="col-md-6 col-sm-12">
                    <div class="block">
                        <div class="form-group-2">
                            ...
                            <button class="btn btn-default" type="submit" action="insert.php" method="POST"><?php echo($button4); ?></button>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="block">
                    ...
                    <ul class="address-block">
                        <li>
                            <i class="ion-ios-location-outline"></i><?php echo($add1); ?>
                        </li>
                        <li>
                            <i class="ion-ios-email-outline"></i><?php echo($add2); ?>
                        </li>
                        <li>
                            <i class="ion-ios-telephone-outline"></i>P<?php echo($add3); ?>
                        </li>
                    </ul>
