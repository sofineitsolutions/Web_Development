			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<div class="block">
						...
						<p class="copyright-text"><?php echo($footer1);  ?> <a href="../https://themefisher.com/" target="_blank"><?php echo($footer2);  ?><a href="../https://themefisher.com/free-bootstrap-templates/"><?php echo($footer3);  ?></a>
						</p>
					</div>
				</div>
			</div>
