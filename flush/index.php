        			...
        			<div class="row h_blog_item">
						<div class="col-lg-6">
							<div class="h_blog_text">
								...
								echo"<p>".$des4."</p>";
								echo"<a class='main_btn2' href='#'>".$button5."</a>";?>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
        ...
        <section class="service_area p_120">
        	<div class="container box_1620">
        		...
        		<div class="row m0 service_inner">
        			...
        			<div class="col-lg-3 col-md-6 p0">
        				<div class="service_text">
						<?php echo"<h4>".$world5."</h4>";
        				echo"<p>".$des7."</p>";?>
        				</div>
        			</div>
        			<div class="col-lg-3 col-md-6 p0">
        				<div class="service_text">
						<?php echo"<h4>".$world6."</h4>";
        				echo"<p>".$des8."</p>";?>
        				</div>
        			</div>
        			<div class="col-lg-3 col-md-6 p0">
        		...
        		<div class="feedback_inner p_100">
        			<div class="row">
        				<div class="col-lg-5">
        					...
        					<?php echo"<h3>".$feedback."</h3>";
        					echo"<p>".$feeedback_des."</p>";?>
        					</div>
        				</div>
        				<div class="col-lg-7">
