                    ...
                    <div class="col-lg-9">
                        <form class="row contact_form" action="../insert.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="world" value="<?php echo $world;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="button5" value="<?php echo $button5;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="service" value="<?php echo $service;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="world5" value="<?php echo $world5;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="des7" value="<?php echo $des7;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="world6" value="<?php echo $world6;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="des8" value="<?php echo $des8;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="world7" value="<?php echo $world7;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="des9" value="<?php echo $des9;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="feedback" value="<?php echo $feedback;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="feeedback_des" value="<?php echo $feeedback_des;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="access" value="<?php echo $access;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="access1" value="<?php echo $access1;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="access2" value="<?php echo $access2;?>">
                                </div>
                                <div class="form-group">
