                        ...
                        <form class="row contact_form" action="insert3.php" method="post">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="project_details" value="<?php echo $project_details;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="project_details1" value="<?php echo $project_details1;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="colorlib_name" value="<?php echo $colorlib_name;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="des1" value="<?php echo $des1;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="rating" value="<?php echo $rating;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="client" value="<?php echo $client;?>"><template></template>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="website" value="<?php echo $website;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="completed" value="<?php echo $completed;?>">
                                </div>
                                <div class="form-group">
