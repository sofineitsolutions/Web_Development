                    ...
                    <div class="col-lg-9">
                        <form class="row contact_form" action="../insert1.php" method="post">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="about_us1"value="<?php echo $about_us1;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="life" value="<?php echo $life;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="here_to" value="<?php echo $here_to;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="feedaback"value="<?php echo $feedaback;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="feedback_des" value="<?php echo $feedback_des;?>">
                                </div>
                                <div class="form-group">
