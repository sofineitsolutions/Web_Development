          ...
          <div class="col-lg-6">
            <form action="insert3.php" method="post">
              ...
              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="sdes3"  value="<?php echo $sdes3;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="sdes4"  value="<?php echo $sdes4;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="prof4"  value="<?php echo $prof4;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="name5" value="<?php echo $name5;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="prof5"  value="<?php echo $prof5;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="name6"  value="<?php echo $name6;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="prof6"  value="<?php echo $prof6;?>">
                                </div>
