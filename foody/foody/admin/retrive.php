            ...
            <form action="../insert.php" method="post">
              ...
              <div class="col-md-6">    
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="sep_menu2" value="<?php echo $sep_menu2;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="price3" value="<?php echo $price3;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="sep_menu3" value="<?php echo $sep_menu3;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="price4" value="<?php echo $price4;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="sep_menu4" value="<?php echo $sep_menu4;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="prof3" value="<?php echo $prof3;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="blog" value="<?php echo $blog;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="blog1" value="<?php echo $blog1;?>">
                                </div>
                                <div class="form-group">
