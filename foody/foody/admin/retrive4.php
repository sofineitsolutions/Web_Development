          ...
          <div class="col-lg-6">
            <form action="insert4.php" method="post">
              ...
              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="news2" value="<?php echo $news2;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="news3"value="<?php echo $news3;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="news4" value="<?php echo $news4;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="news5" value="<?php echo $news5;?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="news6" value="<?php echo $news6;?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="date6" value="<?php echo $date6;?>">
                                </div>
                                <div class="form-group">
