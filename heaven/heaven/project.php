                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="single_project_text">
                                        ...
                                        <?php echo("<a href='single_project.html' class='admin_name'>" . $name1 . "</a>");
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="single_project_text">
                                        ...
                                        <?php echo("<a href='single_project.html' class='admin_name'>" . $name2 . "</a>");
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="single_project_text">
                                        <img src="img/client/client_2.png" class="client_img" alt="">
                                        <?php echo("<a href='single_project.html' class='admin_name'>" . $name3 . "</a>");
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="single_project_text">
                                        <img src="img/client/client_3.png" class="client_img" alt="">
                                        <?php echo("<a href='single_project.html' class='admin_name'>" . $name4 . "</a>");
                        ...
                        <div class="single_project_slide">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="single_project_text">
                                        <img src="img/client/client_2.png" class="client_img" alt="">
                                        <?php echo("<a href='single_project.html' class='admin_name'>" . $name5 . "</a>");
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="single_project_text">
                                        <img src="img/client/client_3.png" class="client_img" alt="">
                                        <?php echo("<a href='single_project.html' class='admin_name'>" . $name6 . "</a>");
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="single_project_text">
                                        <img src="img/client/client_2.png" class="client_img" alt="">
                                        <?php echo("<a href='single_project.html' class='admin_name'>" . $name7 . "</a>");
                                        echo("<span>" . $post7 . "</span>");
                                        echo("<p>" . $dec7 . "</p>"); ?>
                                        <a href="single_project.html" class="btn_1">learn more <span><img
                                                    src="img/icon/left.svg" alt=""></span> </a>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="single_project_text">
                                        <img src="img/client/client_3.png" class="client_img" alt="">
                                        <?php echo("<a href='single_project.htmsingle_project.html' class='admin_name'>" . $name8 . "</a>");
                                        echo("<span>" . $post8 . "</span>");
                                        echo("<p>" . $dec8 . "</p>"); ?>
                                        <a href="single_project.html" class="btn_1">learn more <span><img
                                                    src="img/icon/left.svg" alt=""></span> </a>
                                    </div>
