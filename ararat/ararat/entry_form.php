	...
	<div class="col-md-30 well">
		...
		<div class="col-md-4">
			<form method="POST" action="insert1.php">
					...
					<label>title</label>
					<input type="text" class="form-control" name="db_title" required="required"/>
				</div>
				<div class="form-group">
					<label>subtitle</label>
					<input type="text" class="form-control" name="db_subtitle" required="required"/>
				</div>
