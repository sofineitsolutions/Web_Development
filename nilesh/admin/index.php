        ...
        .$a."</a></h1>";?>
			<nav id="colorlib-main-menu" role="navigation">
                ...
                <?php echo	"<li class='colorlib-active'><a href='index.php'>".$b."</a></li>";
				 ...
				 <?php echo"<li><a href='blog.php'>".$f."</a></li>";?>
				 <?php echo"<li><a href='contact.php'>".$g."</a></li>";
				 ?>
				</ul>
			</nav>
				...
				<div class="hero-wrap">
					...
					<div class="d-flex align-items-center js-fullheight">
						...
						<div class="author-info text p-3 p-md-5">
							<div class="desc">
							<?php echo	"<span class='subheading'>".$i."</span>";
							echo"<h1 class='big-letter'>".$a."</h1>";
							echo"<h1 class='mb-4'><span>".$a."</span>" .$j. "<span>".$k."</span></h1>";?>
							<?php echo "<p class='mb-4'>".$l."<span id='dots'>...</span><span id='more'>".$m10."</span></p><button onclick='myFunction()'id='myBtn'>".$c1."</button>";?>
							<script>
							function myFunction() {
							...
							<?php echo"<h3 class='signature h1'>".$a."</h3>";?>
