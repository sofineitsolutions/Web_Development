	      ...
	      <div class="container">
	        ...
	        <div class="row block-9">
	          <div class="col-md-6 d-flex">
	            <form action="insert3.php" method="POST" class="bg-light p-5 contact-form">
	              <div class="form-group">
	                <input type="text" class="form-control" name="Services" placeholder="Enter Your service title">
	              </div>
	              <div class="form-group">
	                <input type="text" class="form-control"  name="Services1" placeholder="Enter Your service title1">
	              </div>
				  <div class="form-group">
	                <input type="text" class="form-control" name="event1" placeholder="Enter Your event1 ">
	              </div>
	              <div class="form-group">
	                <input type="text" class="form-control"  name="des1" placeholder="Enter Your description1 ">
	              </div>
				  <div class="form-group">
	                <input type="text" class="form-control" name="event2" placeholder="Enter Your description ">
	              </div>
	              <div class="form-group">
	                <input type="text" class="form-control"  name="des2" placeholder="Enter Your description ">
	              </div>
				  <div class="form-group">
	                <input type="text" class="form-control" name="event3" placeholder="Enter Your description ">
	              </div>
	              <div class="form-group">
	                <input type="text" class="form-control"  name="des3" placeholder="Enter Your description ">
	              </div>
				  <div class="form-group">
	                <input type="text" class="form-control" name="event4" placeholder="Enter Your description ">
	              </div>
	              <div class="form-group">
	                <input type="text" class="form-control"  name="des4" placeholder="Enter Your description ">
	              </div>
				  <div class="form-group">
	                <input type="text" class="form-control" name="event5" placeholder="Enter Your description ">
	              </div>
	              <div class="form-group">
	                <input type="text" class="form-control"  name="des5" placeholder="Enter Your description ">
	              </div>
				  <div class="form-group">
	                <input type="text" class="form-control" name="event6" placeholder="Enter Your description ">
	              </div>
	              <div class="form-group">
	                <input type="text" class="form-control"  name="des6" placeholder="Enter Your description ">
	              </div>
	              <div class="form-group">
