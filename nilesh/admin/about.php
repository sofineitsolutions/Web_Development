		...
		<div id="colorlib-main">
			<section class="ftco-section-no-padding bg-light">
				<div class="hero-wrap">
					...
					<div class="d-flex">
						<div class="author-image text img p-md-5" style="background-image: url(../images/nauthor.jpg);">
						</div>
						<div class="author-info text p-4 p-md-5 mt-5 mb-5">
							<div class="desc">
							<?php echo"<span class='subheading'>".$m2."</span>";
							echo"<h1 class='big-letter'>".$Name."</h1>";
							echo"<h1 class='mb-4'><span>".$name3."</span></h1>";
                            echo"<p class='mb-4'>".$des."</p>";
							echo"<h3 class='signature h1'>".$Name."</h3>";?>
	    			...
	    			<div class="col-md-10">
			          ...
			          <div class="col-xl-3 col-md-6 d-flex justify-content-center counter-wrap ftco-animate">
			            <div class="block-18">
			             ...
			             <?php echo"<strong class='number' data-number='120'>".$count1."</strong>";
			             echo"<span>".$theme1."</span>";?>
			              </div>
			            </div>
			          </div>
			          <div class="col-xl-3 col-md-6 d-flex justify-content-center counter-wrap ftco-animate">
			            <div class="block-18">
			              <div class="text d-flex align-items-center">
			            <?php echo"<strong class='number' data-number='150'>".$count1."</strong>";
			            echo"<span>".$theme2."</span>";?>
			              </div>
			            </div>
			          </div>
			          <div class="col-xl-3 col-md-6 d-flex justify-content-center counter-wrap ftco-animate">
			            <div class="block-18">
			              <div class="text d-flex align-items-center">
			             <?php echo "<strong class='number' data-number='200'>".$count1."</strong>";
			             echo "<span>".$theme3."</span>";?>
			              </div>
			            </div>
			          </div>
			          <div class="col-xl-3 col-md-6 d-flex justify-content-center counter-wrap ftco-animate">
