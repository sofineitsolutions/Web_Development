  ...
  <?php include("variable.php");?>
	<div id="colorlib-page">
		...
		<div id="colorlib-main">
	        ...
	        <?php echo "<p class='breadcrumbs'><span class='mr-2'><a href='index.html'>".$b."</a></span> <span>".$j7."</span></p>";
	           echo "<h1 class='bread'>".$e."</h1>";?>
	          </div>
	        </div>
				</div>
			</section>
	        ...
	        <div class="row">
	          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
	            <div class="media block-6 services py-4 d-block">
	             ...
	             <?php echo "<h3 class='heading mb-3'>".$j8."</h3>";
	              echo  "<p>".$j9."</p>";?>
	              </div>
	            </div>      
	          </div>
	          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
	            <div class="media block-6 services py-4 d-block">
	              ...
	              <div class="media-body p-2 mt-2">
	             <?php echo "<h3 class='heading mb-3'>".$j10."</h3>";
	                echo  "<p>".$j9."</p>";?>
	              </div>
	            </div>      
	          </div>
	          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
	            <div class="media block-6 services py-4 d-block">
	              ...
	              <div class="media-body p-2 mt-2">
	               <?php echo "<h3 class='heading mb-3'>".$k1."</h3>";
                    echo  "<p>".$j9."</p>";?>
	              </div>
	            </div>      
	          </div>
	          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
	            <div class="media block-6 services py-4 d-block">
	              ...
	              <div class="media-body p-2 mt-2">
                  <?php echo "<h3 class='heading mb-3'>".$k2."</h3>";
	                echo  "<p>".$j9."</p>";?>
	              </div>
	            </div>    
	          </div>
	          <div class="col-md-4 d-flex align-sel Searchf-stretch ftco-animate">
	            <div class="media block-6 services py-4 d-block">
	              ...
	              <div class="media-body p-2 mt-2">
                  <?php echo "<h3 class='heading mb-3'>".$k3."</h3>";
	                echo  "<p>".$j9."</p>";?>
	              </div>
	            </div>      
	          </div>
              ...
              <div class="media-body p-2 mt-2">
              <?php echo "<h3 class='heading mb-3'>".$k4."</h3>";
	                echo  "<p>".$j9."</p>";?>
              </div>
            </div>
          </div>
