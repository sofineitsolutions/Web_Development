  ...
  <?php include("variable.php");?>
	<div id="colorlib-page">
		...
		<div id="colorlib-main">
	        ...
	        <?php echo   "<p class='breadcrumbs'><span class='mr-2'><a href='index.html'>".$b."</a></span> <span>".$f."</span></p>";
	        echo  "<h1 class='bread'>".$b5."</h1>";?>
	        </div>
	        </div>
			</div>
			</section>
	    	...
	    	<div class="container">
	    			...
	    			<div class="col-lg-8">
	    				<div class="row">
			    			<div class="col-md-12">
			    				<div class="blog-entry ftco-animate d-md-flex">
				            			...
				            			<div class="meta-wrap">
								<p class="meta">
				              	<?php echo	"<span>".$b7."</span>";
				              	echo"<span><a href='single.html'>".$b8."</a></span>";
				              	echo"<span>".$b9."</span>";?>
				              	</p>
			              	</div>
				            <?php echo "<p class='mb-4'>".$b10."</p>";
				            echo "<p><a href='#' class='btn-custom'>".$c1."<span class='ion-ios-arrow-forward'></span></a></p>";?>
				            </div>
							</div>
			    			</div>
			    			<div class="col-md-12">
			          ...
			          <div class="col">
			            <div class="block-27">
			              <ul>
			                <li><a href="#">&lt;</a></li>
			            <?php echo  "<li class='active'><span>".$c2."</span></li>";
			             echo "<li><a href='#'>".$c3."</a></li>";
                         echo "<li><a href='#'>".$c4."</a></li>";
                         echo "<li><a href='#'>".$c5."</a></li>";
                         echo "<li><a href='#'>".$c6."</a></li>";?>
			                <li><a href="#">&gt;</a></li>
			              </ul>
			            </div>
			          </div>
	            ...
	            <?php echo  "<li><a href='#'>".$c8. "<span>".$c9."</span></a></li>";?>
                    ...
                    <?php echo  "<li><a href='#'>".$b8. "<span>".$d4."</span></a></li>";?>
	              </ul>
	            </div> -->
	            <div class="sidebar-box ftco-animate">
